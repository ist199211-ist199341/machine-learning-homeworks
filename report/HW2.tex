...
\begin{enumerate}[leftmargin=\labelsep,resume]
    \item \textbf{Under a MAP assumption, compute $P(\text{Positive} | x)$ of each testing observation.}
          ...
          Replacing the values on \eqref{ex3-bayes} for each observation,
          using \eqref{ex2-normal} to calculate the values of $p(y_3)$ and
          $p(y_3|\text{pos})$,

          $$
              \begin{aligned}
                  p(\text{pos}, y_1=A, y_2=1, y_3=0.8)
                   & = \frac{p(y_1=A, y_2=1 | \text{pos}) p(y_3=0.8 | \text{pos}) \times p(\text{pos})}{p(y_1=A, y_2=1), p(y_3=0.8)} \\
                   & \approx \frac{\frac{1}{5} \times 1.569 \times \frac{5}{9}}{\frac{2}{9} \times 1.648}                            \\
                   & \approx 0.476
              \end{aligned}
          $$
          ...
          $$
              \begin{aligned}
                  p(\text{pos}, y_1=B, y_2=1, y_3=1.0)
                   & = \frac{p(y_1=B, y_2=1 | \text{pos}) p(y_3=1.0 | \text{pos}) \times p(\text{pos})}{p(y_1=B, y_2=1), p(y_3=1.0)} \\
                   & \approx \frac{\frac{1}{5} \times 1.297 \times \frac{5}{9}}{\frac{2}{9} \times 1.648}                            \\
                   & \approx 0.394
              \end{aligned}
          $$
          ...
          $$
              \begin{aligned}
                  p(\text{pos}, y_1=B, y_2=0, y_3=0.9)
                   & = \frac{p(y_1=B, y_2=0 | \text{pos}) p(y_3=0.9 | \text{pos}) \times p(\text{pos})}{p(y_1=B, y_2=0), p(y_3=0.9)} \\
                   & \approx \frac{\frac{1}{5} \times 1.545 \times \frac{5}{9}}{\frac{3}{9} \times 1.830}                            \\
                   & \approx 0.281
              \end{aligned}
          $$
    ...
    \item {\bfseries
          ...
          of 0.476 and 0.394, which are both greater than 0.3
          and the only negative observation is 0.281, which is lesser

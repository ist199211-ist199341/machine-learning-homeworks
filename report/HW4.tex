              ...
              \begin{footnotesize}
                  $$
                      \begin{aligned}
                          ...
                          \left(x_i - \colorbox{bgreen}{$u_1$}\right) \cdot (x_i - \colorbox{bgreen}{$u_1$})^T                          \\
                                       & = \frac{1}{N_1} \times ( \textcolor{cblue}{\gamma_{1,1} \cdot (x_1 - u_1) \cdot (x_1 - u_1)^T} \\
                                       & \quad + \textcolor{cred}{\gamma_{1,2} \cdot (x_2 - u_1) \cdot (x_2 - u_1)^T}                   \\
                                       & \quad + \textcolor{corange}{\gamma_{1,3} \cdot (x_3 - u_1) \cdot (x_3 - u_1)^T})               \\
                                       & = \frac{1}{1.25157} \times ( \textcolor{cblue}{0.74279 \cdot \left(
                              \begin{pmatrix}
                                  1 \\
                                  2
                              \end{pmatrix}
              ...
              \begin{footnotesize}
                  $$
                      \begin{aligned}
                          ...
                          \left(x_i - \colorbox{byellow}{$u_2$}\right) \cdot (x_i - \colorbox{byellow}{$u_2$})^T                        \\
                                       & = \frac{1}{N_2} \times ( \textcolor{cblue}{\gamma_{2,1} \cdot (x_1 - u_2) \cdot (x_1 - u_2)^T} \\
                                       & \quad + \textcolor{cred}{\gamma_{2,2} \cdot (x_2 - u_2) \cdot (x_2 - u_2)^T}                   \\
                                       & \quad + \textcolor{corange}{\gamma_{2,3} \cdot (x_3 - u_2) \cdot (x_3 - u_2)^T})               \\
                                       & = \frac{1}{1.74843} \times ( \textcolor{cblue}{0.25721 \cdot \left(
                              \begin{pmatrix}
                                  1 \\
                                  2
                              \end{pmatrix}
